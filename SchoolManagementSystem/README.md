# School Management System - deliverable pack (v2.1.1.0)
...
|---|---|
| `1_Solution` | `SchoolManagementSystem_2.1.1.0_managed.zip` (for TEST/UAT/PROD) and `_unmanaged.zip` (for DEV). Import ONE of them. |
...
- **New in this pack:** AI agent registry, AI suggestions (human review) and AI run log tables; 2 AI drafting flows (off until configured); 5 security roles; **one unified app "School Management System"** (the four original apps are kept); enrolment status additions from the enrolment diagram.
